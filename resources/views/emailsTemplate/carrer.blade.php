										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#62b3ff">
											<tr>
												<td class="p30-20" style="padding: 80px 50px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 white center" style="padding-bottom: 20px; font-family:'Lato', Arial, sans-serif; font-size:44px; line-height:50px; color:#ffffff; text-align:center;">Resourcewise Technologies</td>
														</tr>
														<tr>
																							...
																							<tr>
                                                                                                @if($logodetails[0]->facebook)
                                                                                                    <td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                                        <a href="{{ $logodetails[0]->facebook }}" target="_blank">
                                                                                                        <img src="{{ asset('public/frontend/assets/images/icons/ico_facebook.jpg') }}" width="33" height="33" border="0" alt="" />
                                                                                                    </td>
                                                                                                @endif

                                                                                                @if($logodetails[0]->twitter)
                                                                                                    <td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                                        <a href="{{ $logodetails[0]->twitter }}" target="_blank">
                                                                                                        <img src="{{ asset('public/frontend/assets/images/icons/ico_twitter.jpg') }}" width="33" height="33" border="0" alt="" />
                                                                                                    </td>
                                                                                                @endif

                                                                                                @if($logodetails[0]->instagram)
                                                                                                    <td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                                        <a href="{{ $logodetails[0]->instagram }}" target="_blank">
                                                                                                        <img src="{{ asset('public/frontend/assets/images/icons/ico_instagram.jpg') }}" width="33" height="33" border="0" alt="" />
                                                                                                    </td>
                                                                                                @endif

                                                                                                @if($logodetails[0]->linkedin)
																								<td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                                    <a href="{{ $logodetails[0]->linkedin }}" target="_blank">
                                                                                                    <img src="{{ asset('public/frontend/assets/images/icons/ico_linkedin.jpg') }}" width="33" height="33" border="0" alt="" />
                                                                                                </td>
                                                                                                @endif
																							</tr>
																						</table>
