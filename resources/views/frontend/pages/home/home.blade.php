...
@section('section')
        ...
        <div class="section-heading">
            <div class="row">
                <div class="col-10 mx-auto text-center mb-4">
                    ...
                    <p>We combine the best of Test Automation, Agile Testing, and all forms of classic 
                        software testing with a DevOps and Agile Testing approach, encouraging collaboration and delivering real value at speed to meet customer requirements.</p>
                    <p>
                    ...
                    <p>
                    It’s by combining the different forms of testing you can see below, in tandem with Agile Testing and DevOps delivery practices, that we are able to ensure an effective rollout and that your software works as it should. </p>
                    <p>
    ...
    <div class="row">
        ...
        <img src="{{ asset('public/upload/banner/'.$bannersection[0]->image) }}" alt="service_image">     
       </div>
       <div class="col-6 content-left-layer">
